...
INPUT_FOLDER = "projeto_yolo/hard-hat/annotations"
OUTPUT_FOLDER = "projeto_yolo/converted_helmet/labels"
IMAGE_FOLDER = "projeto_yolo/hard-hat/images"

TARGET_CLASS = "helmet"
CLASS_NAME_YOLO = "capacete"
CLASS_ID = 1  # YOLO class id diferente da máscara (0)
...
for xml_file in os.listdir(INPUT_FOLDER):
    ...
    for obj in root.findall("object"):
        ...
        if label != TARGET_CLASS:
            continue  # ignora outras classes como 'person', 'vest', etc.
